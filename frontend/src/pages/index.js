          ...
          <div className={`container ${styles.about}`}>
            ...
            <div className={styles.about_text}>
              ...
              <p>
                ...
                our code samples or just viewing its usage for use <br /> in
        ...
        <div className={`container ${styles.features}`}>
          ...
          <div className={styles.card_container}>
            ...
            <div className={styles.card}>
              ...
              <p className={styles.feature_description}>
                Collaborate and contribute to our library of aunthentication
            ...
            <div className={styles.card}>
              ...
              <p className={styles.feature_description}>
                View code snippets, comment and engage with the coding
                community.
              </p>
            </div>
          </div>
