        ...
        <main className={styles.main}>
          ...
          <section>
            ...
            <div>
              ...
              <ul>
                <li>
                  - Feel free to post questions and start discussions on any
                  topic relating to displayed code samples.
                </li>
              ...
              <p>
                In the event of a violation, we will take action to protect
                other members of the community. This action might include a
                warning. In the event of repeated violation, the defaulting
                member will be banned from the community.
              </p>
            </div>
          </section>
        </main>
