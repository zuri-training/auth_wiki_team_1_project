  ...
  return (
    <main className={styles.main}>
      ...
      <section>
        ...
        <div>
          <p>
            AuthWiki is a user-friendly platform that provides developers with a
            library of authentication code samples. Non-registered users can
            glance through code samples, but registered users have full access
            to view, download and comment on code samples.
          </p>
          <p>
            Our library provides you with a handful of secure and flexible code
            samples that span across a range of languages, helping you save time
            and cost of developing your own authentication codes from scratch.
          </p>
          <p>
            Browse through our{" "}
